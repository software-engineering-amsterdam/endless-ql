        buf.write("WX\f\5\2\2XY\7\22\2\2Y^\5\f\7\6Z[\f\4\2\2[\\\7\23\2\2")
        buf.write("\\^\5\f\7\5]Q\3\2\2\2]T\3\2\2\2]W\3\2\2\2]Z\3\2\2\2^a")
        buf.write("\3\2\2\2_]\3\2\2\2_`\3\2\2\2`\r\3\2\2\2a_\3\2\2\2bg\5")
        buf.write("\20\t\2cd\5\20\t\2de\5\22\n\2eg\3\2\2\2fb\3\2\2\2fc\3")
        buf.write("\2\2\2g\17\3\2\2\2hi\7\4\2\2ij\7\16\2\2jk\5\f\7\2kl\7")
        buf.write("\17\2\2lm\5\4\3\2m\21\3\2\2\2no\7\5\2\2op\5\4\3\2p\23")
        buf.write("\3\2\2\2qr\t\2\2\2r\25\3\2\2\2\n\37&+\63O]_f")
        return buf.getvalue()
...
class QLParser ( Parser ):
    ...
    literalNames = [ "<INVALID>", "'form'", "'if'", "'else'", "<INVALID>", 
                     "<INVALID>", "<INVALID>", "'boolean'", "'money'", "':'", 
                     "'{'", "'}'", "'('", "')'", "'='", "'!'", "'&&'", "'||'", 
                     "<INVALID>", "'*'", "'/'", "'+'", "'-'", "<INVALID>", 
                     "'>'", "'<'", "'<='", "'>='", "'=='", "'!='" ]

    symbolicNames = [ "<INVALID>", "FORM", "IF_TOKEN", "ELSE_TOKEN", "INT", 
                      "ID", "STRING", "BOOLEAN", "MONEY", "COL", "BRACKETL", 
    ...
    def block(self):
        ...
        try:
            ...
            self._errHandler.sync(self)
            _la = self._input.LA(1)
            while (((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << QLParser.IF_TOKEN) | (1 << QLParser.ID) | (1 << QLParser.STRING))) != 0):
                self.state = 32
                self.statement()
                self.state = 36
                self._errHandler.sync(self)
    ...
    class QuestionContext(ParserRuleContext):
        ...
        def typeDeclaration(self):
            return self.getTypedRuleContext(QLParser.TypeDeclarationContext,0)
    ...
    class ExpressionContext(ParserRuleContext):
        ...
        def OTHER(self):
            return self.getToken(QLParser.OTHER, 0)
    ...
    def expression(self, _p:int=0):
        ...
        try:
            ...
            self._errHandler.sync(self)
            token = self._input.LA(1)
            if token in [QLParser.BOOLEAN]:
                self.state = 66
                self.match(QLParser.BOOLEAN)
                pass
                ...
                self.expression(6)
                pass
            elif token in [QLParser.OTHER]:
                self.state = 75
                localctx._OTHER = self.match(QLParser.OTHER)
    ...
    class TypeDeclarationContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return QLParser.RULE_typeDeclaration
    ...
    def typeDeclaration(self):
        ...
        localctx = QLParser.TypeDeclarationContext(self, self._ctx, self.state)
        ...
        try:
            ...
            self.state = 111
            _la = self._input.LA(1)
            if not(_la==QLParser.BOOLEAN or _la==QLParser.MONEY):
