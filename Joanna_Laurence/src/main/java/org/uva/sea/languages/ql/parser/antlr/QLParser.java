...
public class QLParser extends Parser {
    ...
    public static class FormContext extends ParserRuleContext {
        ...
        public TerminalNode IDENT() {
            return getToken(QLParser.IDENT, 0);
        }
    ...
    public static class TypeContext extends ParserRuleContext {
        ...
        public TerminalNode TYPES() {
            return getToken(QLParser.TYPES, 0);
        }
    ...
    public static class BoolContext extends ParserRuleContext {
        ...
        public TerminalNode BOOLEAN_TRUE() {
            return getToken(QLParser.BOOLEAN_TRUE, 0);
        }

        public TerminalNode BOOLEAN_FALSE() {
            return getToken(QLParser.BOOLEAN_FALSE, 0);
        }
    ...
    public static class DecContext extends ParserRuleContext {
        ...
        public TerminalNode DECIMAL() {
            return getToken(QLParser.DECIMAL, 0);
        }
