...
public class LexerTest
{
    ...
    @Test
    public void parseLabelVariableAssignedABoolean() throws IOException
    {
    ...
    @Test
    public void parseLabelVariableAssignedString() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("LABEL");
        test.add("VAR");
    ...
    @Test
    public void parseLabelVariableAssignedInteger() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("LABEL");
        test.add("VAR");
    ...
    @Test
    public void parseLabelVariableAssignedDate() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("LABEL");
        test.add("VAR");
    ...
    @Test
    public void parseLabelVariableAssignedDecimal() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("LABEL");
        test.add("VAR");
    ...
    @Test
    public void parseLabelVariableAssignedMultipleAnswer() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("LABEL");
        test.add("VAR");
    ...
    @Test
    public void parseLabelVariableAssignedMoney() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("LABEL");
        test.add("VAR");
    ...
    @Test
    public void parseLabelVariableAssignedCurrency() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("LABEL");
        test.add("VAR");
    ...
    @Test
    public void parseIfConditionQuestion() throws IOException
    {
        LinkedList<String> test = new LinkedList<String>();
        test.add("IF");
        test.add("LPAREN");
