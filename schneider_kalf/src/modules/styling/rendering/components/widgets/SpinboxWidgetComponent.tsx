  ...
  const renderSpinboxInputs = () => {
    return (
        <InputGroupAddon className="input-group-append">
          <Button color="outline-secondary" onClick={() => props.onChange(value.increment())}>+</Button>
          <Button color="outline-secondary" onClick={() => props.onChange(value.decrement())}>-</Button>
        </InputGroupAddon>
    );
  };
