...
class QLSListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by QLSParser#section.
    def enterSection(self, ctx:QLSParser.SectionContext):
        pass

    # Exit a parse tree produced by QLSParser#section.
    def exitSection(self, ctx:QLSParser.SectionContext):
        pass


    # Enter a parse tree produced by QLSParser#question.
    def enterQuestion(self, ctx:QLSParser.QuestionContext):
        pass

    # Exit a parse tree produced by QLSParser#question.
    def exitQuestion(self, ctx:QLSParser.QuestionContext):
        pass
