...
public class StrAdd extends AbstractEvaluator<StrLiteral> {
    
    public StrAdd(StrLiteral firstOperand) {
        super(firstOperand);
    }
    ...
    public Literal<?> visit(StrLiteral secondOperand) {
        return new StrLiteral(firstOperand.getValue().concat(secondOperand.getValue()));
    }
