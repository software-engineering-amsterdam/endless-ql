...
public class QLBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements QLVisitor<T> {
     ...
     */
    @Override
    public T visitNegation(QLParser.NegationContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitParameter(QLParser.ParameterContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitComparation(QLParser.ComparationContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitLogicalAnd(QLParser.LogicalAndContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitAddSub(QLParser.AddSubContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitParameterGroup(QLParser.ParameterGroupContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitLogicalOr(QLParser.LogicalOrContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitMulDiv(QLParser.MulDivContext ctx) {
        return visitChildren(ctx);
    }
     ...
     */
    @Override
    public T visitCalculatedValue(QLParser.CalculatedValueContext ctx) {
        return visitChildren(ctx);
    }
