package ql.evaluator.comparisons.greater;
...
public class DateGreater extends AbstractEvaluator<Date> {

    public DateGreater(Date firstOperand) {
        super(firstOperand);
    }
    ...
    public Value<?> visit(Date secondOperand) {
        return new Bool(firstOperand.getValue().isAfter(secondOperand.getValue()));
    }
