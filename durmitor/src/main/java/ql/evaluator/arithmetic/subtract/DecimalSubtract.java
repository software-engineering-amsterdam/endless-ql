package ql.evaluator.arithmetic.subtract;
...
public class DecimalSubtract extends AbstractEvaluator<DecimalLiteral> {
    
    public DecimalSubtract(DecimalLiteral firstOperand) {
        super(firstOperand);
    }
