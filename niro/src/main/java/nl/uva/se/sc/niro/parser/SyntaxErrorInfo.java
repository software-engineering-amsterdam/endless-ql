...
public class SyntaxErrorInfo extends ParseErrorInfo {
    private int line;
    private int column;
    ...
    public SyntaxErrorInfo(int line, int column, String offendingSymbol, String errorMessage, List<String> rules, RecognitionException cause) {
        this.line = line;
        this.column = column;
