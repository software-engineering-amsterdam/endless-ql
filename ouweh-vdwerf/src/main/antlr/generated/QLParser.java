...
public class QLParser extends Parser {
    ...
    public static class FormContext extends ParserRuleContext {
        ...
        public TerminalNode OPEN_BRACKET() {
            return getToken(QLParser.OPEN_BRACKET, 0);
        }

        public TerminalNode CLOSE_BRACKET() {
            return getToken(QLParser.CLOSE_BRACKET, 0);
        }
    ...
    public static class QuestionContext extends StatementContext {
        ...
        public QuestionContext(StatementContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IfElseStatementContext extends StatementContext {
        ...
        public List<TerminalNode> OPEN_BRACKET() {
            return getTokens(QLParser.OPEN_BRACKET);
        }
        ...
        public List<TerminalNode> CLOSE_BRACKET() {
            return getTokens(QLParser.CLOSE_BRACKET);
        }
    ...
    public static class StringLiteralContext extends ExpressionContext {
        public StringLiteralContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ParameterContext extends ExpressionContext {
        public ParameterContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ComparationContext extends ExpressionContext {
        ...
        public ComparationContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class IntegerLiteralContext extends ExpressionContext {
        public IntegerLiteralContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LogicalAndContext extends ExpressionContext {
        ...
        public LogicalAndContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class ParameterGroupContext extends ExpressionContext {
        public ParameterGroupContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class LogicalOrContext extends ExpressionContext {
        ...
        public LogicalOrContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
    ...
    public static class BooleanLiteralContext extends ExpressionContext {
        ...
        public BooleanLiteralContext(ExpressionContext ctx) {
            copyFrom(ctx);
        }
