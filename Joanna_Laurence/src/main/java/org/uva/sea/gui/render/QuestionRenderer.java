...
import org.uva.sea.gui.model.IQuestionModelFactory;
...
public class QuestionRenderer implements IRenderable<List<QuestionData>> {
    ...
    private List<BaseQuestionModel> getBaseQuestionModels(Iterable<QuestionData> data) {
        IQuestionModelFactory factory = new QuestionModelFactoryImpl();
