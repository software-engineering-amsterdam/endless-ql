...
public class ExpressionVisitor extends QLBaseVisitor<Expression>{
    ...
    public Expression visitBinaryExpr(QLParser.BinaryExprContext ctx){
        ...
        if(operator.charAt(0) == '+'){ return new AdditionExpression(left, right);}
        else if(operator.charAt(0) == '-'){ return new SubtractExpression(left, right);}
        else if(operator.charAt(0) == '*'){ return new MultiplicationExpression(left, right);}
        else if(operator.charAt(0) == '/'){ return new DivisionExpression(left, right);}

        else if(operator.charAt(0) == '>'){
            if(operator.charAt(1) == '=') { return new GreaterOrEqualExpression(left, right);}
            else { return new GreaterThanExpression(left, right);}}

        else if(operator.charAt(0) == '<'){
            if(operator.charAt(1) == '='){ return new LessOrEqualExpression(left, right);}
            else { return new LessThanExpression(left, right);}}

        else if(operator.charAt(0) == '='){ return new EqualExpression(left, right);}
        else if(operator.charAt(0) == '!'){ return new NotEqualExpression(left, right);}
        else if(operator.charAt(0) == '&'){ return new AndExpression(left, right);}
        else if(operator.charAt(0) == '|'){ return new OrExpression(left, right);}
    ...
    public Expression visitUnaryExpr(QLParser.UnaryExprContext ctx){
        ...
        if(operator.charAt(0) == '-'){ return new NegationExpression(expr);}
        else if(operator.charAt(0) == '!'){ return new NotExpression(expr);}
