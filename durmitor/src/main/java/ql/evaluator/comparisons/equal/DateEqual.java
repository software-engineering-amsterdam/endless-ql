...
public class DateEqual extends AbstractEvaluator<Date> {

    public DateEqual(Date firstOperand) {
        super(firstOperand);
    }
    ...
    public Value<?> visit(Date secondOperand) {
        return new Bool(firstOperand.getValue().isEqual(secondOperand.getValue()));
    }
