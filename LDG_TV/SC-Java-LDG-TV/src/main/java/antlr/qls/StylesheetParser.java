...
public class StylesheetParser extends Parser {
    ...
    public static class StylesheetBuilderContext extends ParserRuleContext {
        ...
        public TerminalNode CURLY_BRACKET_OPEN() {
            return getToken(StylesheetParser.CURLY_BRACKET_OPEN, 0);
        }
        ...
        public TerminalNode CURLY_BRACKET_CLOSE() {
            return getToken(StylesheetParser.CURLY_BRACKET_CLOSE, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_stylesheetBuilder;
        }
    ...
    public static class SectionNodeStructureContext extends ParserRuleContext {
        ...
        @Override
        public int getRuleIndex() {
            return RULE_sectionNodeStructure;
        }
    ...
    public static class IdentifierContext extends ParserRuleContext {
        ...
        public TerminalNode CHARACTERS() {
            return getToken(StylesheetParser.CHARACTERS, 0);
        }
    ...
    public static class LabelContext extends ParserRuleContext {
        ...
        public TerminalNode STRING() {
            return getToken(StylesheetParser.STRING, 0);
        }
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        public TerminalNode NUMBERS() {
            return getToken(StylesheetParser.NUMBERS, 0);
        }

        public TerminalNode SPECIAL_CHAR() {
            return getToken(StylesheetParser.SPECIAL_CHAR, 0);
        }
    ...
    public static class RadioOptionsContext extends ParserRuleContext {
        ...
        public TerminalNode BRACKET_OPEN() {
            return getToken(StylesheetParser.BRACKET_OPEN, 0);
        }
        ...
        public TerminalNode BRACKET_CLOSE() {
            return getToken(StylesheetParser.BRACKET_CLOSE, 0);
        }

        @Override
        public int getRuleIndex() {
            return RULE_radioOptions;
        }
