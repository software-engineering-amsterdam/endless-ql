      ...
      assert(
        result === Right(
          QLForm(
            "duplicateLabel",
            List(
              Question("q1", "duplicate-label", IntegerType, Some(IntegerAnswer(Some(1)))),
              Question("q2", "duplicate-label", IntegerType, Some(IntegerAnswer(Some(1))))
            ),
    ...
    "checkOperandsOfInvalidTypeToOperators" can {
      "return error for operands of invalid type to operator" in {
        val qlForm = QLForm(
          "invalidTypes",
          Seq(
            Question("q1", "duplicate-label", IntegerType, Some(BinaryOperation(Mul, StringAnswer(), StringAnswer())))
          ))
      ...
      "return error for operands of invalid type to eachother" in {
        val qlForm = QLForm(
          "invalidTypes",
          Seq(
            Question("q1", "duplicate-label", IntegerType, Some(BinaryOperation(Eq, StringAnswer(), IntegerAnswer())))
          ))
      ...
      "return no error for operands of different types but valid: Decimal and Integer" ignore {
        val qlForm = QLForm(
          "invalidTypes",
          Seq(
            Question("q1", "duplicate-label", IntegerType, Some(BinaryOperation(Eq, DecimalAnswer(), IntegerAnswer())))
          ))
      ...
      "return no error for operands of different types but valid: Money and Integer" ignore {
        val qlForm = QLForm(
          "invalidTypes",
          Seq(
            Question("q1", "duplicate-label", IntegerType, Some(BinaryOperation(Eq, MoneyAnswer(), IntegerAnswer())))
          ))
    ...
    "checkCyclicDependenciesBetweenQuestions" can {
      "return the AST when no cyclic references are found" in {
        val qlForm = QLForm(
          ...
          Seq(
            ...
            Question("q3", "question3", IntegerType, Some(IntegerAnswer()))
          )
        )
        val result = TypeChecker.pipeline(qlForm)
      ...
      "and return an error when cyclic references are found inside expressions" in {
        val qlForm = QLForm(
          ...
          Seq(
            Question("q1", "question1", IntegerType, Some(Reference("q3"))),
            Question("q2", "question2", IntegerType, Some(Reference("q1"))),
            Question("q3", "question3", IntegerType, Some(UnaryOperation(Sub, Reference("q2"))))
          )
        )
      ...
      "and return an error when cyclic references are found inside expressions with multiple paths" in {
        val qlForm = QLForm(
          "duplicateLabel",
          Seq(
            Question("q1", "question1", IntegerType, Some(BinaryOperation(Mul, Reference("q2"), Reference("q3")))),
            Question("q2", "question2", IntegerType, Some(Reference("q3"))),
            Question("q2", "question2", IntegerType, Some(Reference("q1"))),
            Question("q3", "question3", IntegerType, Some(UnaryOperation(Sub, IntegerAnswer())))
          )
        )
      ...
      "and return an error when multiple cyclic references are found" in {
        val qlForm = QLForm(
          "cyclicDependencies",
          Seq(
            Question("q1", "question1", IntegerType, Some(IntegerAnswer())),
            Question("q2", "question2", IntegerType, Some(Reference("q3"))),
            Question("q3", "question3", IntegerType, Some(Reference("q2"))),
        ...
        val qlForm = QLForm(
          ...
          Seq(
            Question(
              ...
              IntegerType,
              Some(UnaryOperation(Sub, Reference("1")))
            ),
            Question("q2", "question2", IntegerType, Some(IntegerAnswer(1))),
            Question("q3", "question3", IntegerType, Some(Reference("q2")))
          )
