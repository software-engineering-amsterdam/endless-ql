...
class StyleControlMoneyBuilder extends StyleControlBuilder {
	...
	def dispatch HBox styleMoney(ControlWrapperMoney controlWrapperMoney, WidgetSpinbox widgetSpinbox,
		DefaultStyle defaultStyleToApply) {
	...
	def dispatch HBox styleMoney(ControlWrapperMoney controlWrapperMoney, WidgetSlider widgetSlider,
		DefaultStyle defaultStyleToApply) {
