...
public class DecimalEqual extends AbstractEvaluator<Decimal> {

    public DecimalEqual(Decimal firstOperand) {
        super(firstOperand);
    }
    ...
    public Value<?> visit(Int secondOperand) {
        return new Bool(firstOperand.getValue().doubleValue() == secondOperand.getValue());
    }
