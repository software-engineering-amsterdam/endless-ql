...
class QLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by QLParser#form_id.
    def enterForm_id(self, ctx:QLParser.Form_idContext):
        pass

    # Exit a parse tree produced by QLParser#form_id.
    def exitForm_id(self, ctx:QLParser.Form_idContext):
        pass


    # Enter a parse tree produced by QLParser#var.
    def enterVar(self, ctx:QLParser.VarContext):
        pass

    # Exit a parse tree produced by QLParser#var.
    def exitVar(self, ctx:QLParser.VarContext):
        pass


    # Enter a parse tree produced by QLParser#vartype.
    def enterVartype(self, ctx:QLParser.VartypeContext):
        pass

    # Exit a parse tree produced by QLParser#vartype.
    def exitVartype(self, ctx:QLParser.VartypeContext):
        pass
